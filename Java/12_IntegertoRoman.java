...
class Solution {
    ...
    static final ArrayList<String> M = new ArrayList(Arrays.asList("", "M", "MM", "MMM"));
    static final ArrayList<String> C = new ArrayList(Arrays.asList("", "C", "CC", "CCC", "CD", "D", "DC", "DCC", "DCCC", "CM"));
