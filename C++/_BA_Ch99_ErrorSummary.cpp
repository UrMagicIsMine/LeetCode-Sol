...
// Prob4: [Important] follow up O(log(M+N)) array
// Prob5: loop the whole length;
// Prob8: be careful about leading 0;
// Prob10: [Important] Spent more time!!!, be careful about case ".*"
...
// Prob41: continue swap, 1) Be careful about index, 2) be careful about [1,1]
// Prob44: [Important] Spent more time!!!, analysis IC, DP table
...
// Prob76: [Important] Spent more time!!! Two pointer + hash map
// of whether it's the desired value in this run; take care when nums[i] == 2,
// after swap, nums[i] could be any value, so i--
// Prob84: [Important] Spent more time!!! use stack to maintain index
...
// Prob140: [Important] backtracking, TLE.
...
// prob322: DP solution
// prob324: [Important] sort and reorder, from back to front, use nth_element
